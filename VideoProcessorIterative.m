function VideoProcessorIterative(prev_roi,n_ROI,startFrame,saveROI)
...
%2nd input for this function is how many ROIs are desired by the user
...
%4th input specifies if you want to save the ROI information into a .mat file
    ...
    for gg=1:size(fileName,2)
        ...
        %waits for user to accept ROIs by pressing enter or clicking to the side
